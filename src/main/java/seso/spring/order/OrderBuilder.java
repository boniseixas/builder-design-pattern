package seso.spring.order;

import seso.spring.coldDrink.size.*;
import seso.spring.model.Item;
import seso.spring.types.flavorCheeze.ExtraLargeCheezePizza;
import seso.spring.types.flavorCheeze.LargeCheezePizza;
import seso.spring.types.flavorCheeze.MediumCheezePizza;
import seso.spring.types.flavorCheeze.SmallCheezePizza;
import seso.spring.types.flavorMasala.ExtraLargeMasalaPizza;
import seso.spring.types.flavorMasala.LargeMasalaPizza;
import seso.spring.types.flavorMasala.MediumMasalaPizza;
import seso.spring.types.flavorMasala.SmallMasalaPizza;
import seso.spring.types.flavorOnion.ExtraLargeOnionPizza;
import seso.spring.types.flavorOnion.LargeOnionPizza;
import seso.spring.types.flavorOnion.MediumOnionPizza;
import seso.spring.types.flavorOnion.SmallOnionPizza;
import seso.spring.types.sizeNonVegPizza.ExtraLargeNonVegPizza;
import seso.spring.types.sizeNonVegPizza.LargeNonVegPizza;
import seso.spring.types.sizeNonVegPizza.MediumNonVegPizza;
import seso.spring.types.sizeNonVegPizza.SmallNonVegPizza;
...
public class OrderBuilder {
    public OrderedItems preparePizza() throws IOException {
        ...
        System.out.println("Entre the choice of Pizza:");
        System.out.println("===========================");
